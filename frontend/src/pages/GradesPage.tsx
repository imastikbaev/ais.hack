    ...
    <div className="p-6 space-y-6">
      ...
      {isLoading ? (
        ...
        <>
          <div className="card">
            ...
            <ResponsiveContainer width="100%" height={200}>
              <BarChart data={subjectAvgs}>
                ...
                <Tooltip formatter={(v: any) => [Number(v).toFixed(2), 'Средний балл']} />
          ...
          <div className="card">
            <h3 className="font-semibold text-slate-700 mb-4">Последние оценки</h3>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-slate-100">
                    <th className="text-left py-2 pr-4 text-slate-500 font-medium">Предмет</th>
                    <th className="text-left py-2 pr-4 text-slate-500 font-medium">Тип</th>
                    <th className="text-left py-2 pr-4 text-slate-500 font-medium">Тема</th>
                    <th className="text-left py-2 pr-4 text-slate-500 font-medium">Дата</th>
                    <th className="text-right py-2 text-slate-500 font-medium">Оценка</th>
                  </tr>
                </thead>
                <tbody>
